...
DraggableBar.Position = UDim2.new(0, 0, 0, 0) -- Adjusted to be at the top
...
local function createSlider(parent, position, text, minValue, maxValue, defaultValue)
...
local function createDropdownButton(parent, position, text, options)
...
toggleControlButton = Instance.new("TextButton")
ToggleButton.Parent = Frame
ToggleButton.BackgroundColor3 = Color3.fromRGB(36, 36, 36)
ToggleButton.Size = UDim2.new(0, 50, 0, 50)
ToggleButton.Position = UDim2.new(1, -60, 0, 10) -- set in a position in header
